...
\begin{document}
    \begin{tikzpicture}
        ...
        yticklabels         =   {}
            ...
            \node[align=center,anchor=center,text width=2cm] at (-3.5, 5.45) {\tiny\texttt{timeDiv:}\\[-5pt]$0.1\, \textrm{ms/div}$};
            \node[align=center,anchor=center,text width=2cm] at (-1, 5.45) {\tiny\texttt{channel A:}\\[-5pt]$1\, \textrm{V/div}$};
            \node[align=center,anchor=center,text width=2cm] at (1.5, 5.45) {\tiny\texttt{channel B:}\\[-5pt]$1\, \textrm{V/div}$};
            ...
            \addplot[samples=300,smooth, thick, color=main20] {3*sin(90*\x - 90)};
        \end{axis}
    \end{tikzpicture}
\end{document}