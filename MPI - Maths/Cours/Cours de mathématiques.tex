...
\begin{document}
 ...
 \begin{enumerate}
     ...
     \boxans{
        ...
        On pose $\psi = \displaystyle\prod_{d \mid n} \phi_d$. Soit $d \mid n$, il existe $m \in \iint{1, n}$ minimal tel que $n = md$. On a :
        %
        \[ \zeta_k^d = e^{2\ii\frac{k\pi}{d}} = e^{2\ii\frac{km\pi}{n}} = \zeta_{km}^n \]
        %
